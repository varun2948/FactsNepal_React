                ...
                <Fade bottom duration={900} delay={600} distance={"0px"}>
                  <div className="form-address">
                    <ul className="addr-list">
                      ...
                      <li className="addr">
                        <span>
                          <img src="./img/24px.svg" alt="" />
                        </span>
                        <span className="factsNepal-para">+977-1-4469924</span>
                      </li>

                      <li className="addr">
                        <span>
                          <img src="./img/24px (1).svg" alt="" />
                        </span>{" "}
                        <span>
                          <a href="#" className="factsNepal-para">
                            info@factsnepal.com
                          </a>
                        </span>
                      </li>
            ...
            <div className="row">
              ...
              <div className="col-12 offset-0 offset-md-1 col-md-5">
                <div className="footer-right">
                  <span className="site-design-title">
