                ...
                <div className="case-study-content">
                  <div className="case-study-content-wrap">
                    ...
                    <p className="factsNepal-para">
                      The National Youth Policy has recognized that youth are an
                      invaluable asset to the nation, acknowledging youths’ role
                      as agents of economic, social, and political change.
                    </p>
              ...
              <div className="order-2 order-sm-2 order-md-1 col-md-6">
                <div className="case-study-content">
                  <div className="case-study-content-wrap">
                    ...
                    <p className="factsNepal-para">
                      This presentation shares the preliminary findings from the
                      formative research conducted among communities engaged in
                      migrant labour in Baglung district of Nepal.
                    </p>
