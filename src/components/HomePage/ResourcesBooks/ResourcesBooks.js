                    ...
                    <div className="grid-col resources-grid-lft">
                      <div className="grid-content-wrap">
                        <div className="grid-image">
                          <img
                            src="./img/Facts-of-Nepal-2019-book.png"
                            alt="Facts of Nepal 2019"
                          />
                        </div>
                        <div className="grid-content">
                          ...
                          <div className="para-center">
                            <p className="factsNepal-para">
                              Facts Research and Analytics unveiled the latest
                              edition of its yearbook
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="grid-content">
                          ...
                          <div className="para-center">
                            <p className="factsNepal-para">
                              ...
                              and data of various sectors of Nepal presented in
                              a manner that would visually appeal to the
                              readers.
                            </p>
                          </div>
                        </div>
