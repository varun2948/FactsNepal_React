    ...
    render() {
        ...
        return (
            <Fragment>
                        ...
                        <div className="banner-wrap pdt-40">
                            <div className="title-block">
                                <div className="title-wrap">
                                    ...
                                    <p className="banner-content">Discover reliable, contextual and actionable information & insights</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="slider-facts">
                    <div className="container">
                        <div className="slider pdt-100 pdb-20">
                            {/* <div className="slider-facts-container slider-facts-nav"> */}
                            <Slider {...settings} >
                                <div className="slider-img-item red-bg"><figure><img src="./img/all.svg" alt="" /></figure><span>All</span></div>
                                <div className="slider-img-item green-bg"><figure><img src="./img/agriculture.svg" alt="" /></figure><span>Agriculture</span></div>
                                <div className="slider-img-item blue-bg"><figure><img src="./img/communication.svg" alt="" /></figure><span>Communication</span></div>
                                <div className="slider-img-item orange-bg"><figure><img src="./img/crime.svg" alt="" /></figure><span>Crime</span></div>
                                <div className="slider-img-item blue-bg"><figure><img src="./img/economy.svg" alt="" /></figure><span>Economy</span></div>
                                <div className="slider-img-item green-bg"><figure><img src="./img/agriculture.svg" alt="" /></figure><span>Agriculture</span></div>
                            </Slider>
                        </div>


                        <div className="grid-section pdt-90">
                            <div className="slider-facts-container slider-facts-for">

                                <div className="slider-img-item">
                                    <div className="grid-facts1">
                                        <div className="wrap">
                                            <div className="row">
                                                {facts && facts[0] && facts[0].home.map((data, key) => {
                                                    return (
                                                        <div className="col-7 offset-3 col-sm-8 offset-sm-2 offset-md-0 col-md-4" style={{ marginBottom: "30px" }}>
                                                            <Link className="grid-col-link" to={{
                                                                pathname: `/facts/${data.id}`,
                                                                facts_data: data
                                                            }}  >
                                                                <div className="grid-col" id={`left ${key}`}>
                                                                    <figure className="facts1-img">
                                                                        <img className="grid-img" src={data.image} alt="crops-production" />
                                                                    </figure>
                                                                    <div className="content-wrap">
                                                                        <span className="title span-12">{data.category_title}</span>
                                                                        <span className="gridcol-title span-22">{data.title}</span>
                                                                        <span className="title-date span-14"><TimeAgo date={data.public_date} /></span>
                                                                    </div>
                                                                </div>
                                                            </Link>
                                                        </div>
                                                    ...
                                                    <a href="#" className="grid-col-link">
                                                        <div className="grid-col" id="mid">
                                                            ...
                                                            <div className="content-wrap">
                                                                ...
                                                                <span className="gridcol-title span-22">Internet Usage <br />Statistics
                                                            </span>
                                        ...
                                        {/* <a href="#collapse-div" className="click-more link-toggle span-14">
                                            See More
                                    </a> */}
