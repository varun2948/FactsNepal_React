                                ...
                                <div className="col-md-6">
                                    <div className="title-wrap">
                                        <div className="title-center">
                                            <span className="span-subtitle span-16">Infographics Design</span>
                                            <h3 className="factsNepal-title banner-heading">Supplying you with relevant of information in graphic</h3>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                        ...
                        <div className="content-wrap">
                            <div className="heading-wrap pdb-50">
                                <div className="span-center .pdb-40">
                                    <span className="title-info span-22">Data in its raw form is, in most cases, complex, vast and highly intricate.</span>
                                </div>
