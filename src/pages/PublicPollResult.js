...
class PublicPollResult extends Component {
  ...
  render() {
    ...
    const pollresponse =
      localStorage.getItem("pollresult") &&
      JSON.parse(localStorage.getItem("pollresult"));
                ...
                <div className="wrap-center">
                  <div className="title-wrap">
                    ...
                    <div className="btn-wrap">
                      ...
                      <span className="title-date span-12">
                        <TimeAgo date={pollresponse.expiryDate} />
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="publicpoll-group">
                    <form
                      action=""
                      className="publicpoll-form publicpoll-form2"
                    >
                      {pollresponse &&
                        pollresponse.options.map((data, key) => {
                          console.log(
                            (data.votes_count * 100) / pollresponse.totalVotes
                          );
                          const votes_percent = Math.round(
                            (data.votes_count * 100) / pollresponse.totalVotes
                          );
                          ...
                          return (
                            <div
                              className={`form-group inputform ${
                                selectedpoll[0].id == data.id ? "active" : ""
                              } `}
                            >
                              <span
                                className={`input-title span-16 ${
                                  selectedpoll[0].id == data.id
                                    ? "span-yellow"
                                    : ""
                                }`}
                              >
                              ...
                              <span
                                className={`input-status span-16 ${
                                  selectedpoll[0].id == data.id
                                    ? "span-yellow"
                                    : ""
                                }`}
                  ...
                  <div className="row">
                    <div className="col-md-7">
                      <div className="col-wrap-banner">
                        ...
                        <span className="smbanner-span span-16">
                          You voted{" "}
                          <span className="colored-span">
                            {selectedpoll[0].question}
                          </span>{" "}
                          on this poll.
                        </span>
                      </div>
                          ...
                          <li>
                            ...
                            >
                              ...
                              >
                                ...
                                <span className="span-link span-12 fb-share-button">
                                  Share on Facebook
                                </span>
                              </a>
                            </div>
